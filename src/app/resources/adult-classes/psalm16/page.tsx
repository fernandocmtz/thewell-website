...
import { PSALM16_SERIES } from "@/data/psalm16";
import Link from "next/link";
import { motion } from "framer-motion";

export default function Psalm16Page() {
  return (
    <main className="relative min-h-screen bg-[rgb(var(--sand))] overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-24">
        ...
        <h1 className="text-5xl font-bold text-[#1a1a1a] mb-12">
          Psalm 16 Study Series
        </h1>

        {/* Grid */}
        <div className="grid md:grid-cols-2 gap-10">

          {PSALM16_SERIES.map((lesson, i) => (
